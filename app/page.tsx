        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-4">
            <Button
              ...
              asChild
            >
              <Link href="/custo-oportunidade">
                Realize seu Projeto <ArrowRight className="ml-2" />
              </Link>
            </Button>
            <Button
              size="lg"
              ...
              asChild
            >
              <Link href="/seu-patrimonio">
                Potencial Patrimonial <ArrowRight className="ml-2" />
              </Link>
            </Button>
          </div>
